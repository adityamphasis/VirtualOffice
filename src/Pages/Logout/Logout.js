...
export default class LogoutScreen extends React.Component {
  ...
  componentDidMount() {
    ...
    // let url = 'https://accounts.bharti-axalife.com/oidc/logout?' + "id_token_hint=" + this.state.accessToken + "&post_logout_redirect_uri" + "https://"
  ...
  render() {
    return (
      <SafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
        ...
        <Text>Logout successfully done</Text>
